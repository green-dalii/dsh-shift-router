...
npm test            # vitest (160 tests across 10 files: EV routing / failover signatures / judge parsing + prompt contract / orchestration / config schema + migration / telemetry / config registries + GUI form model / whitelist patch)
npm run typecheck
```
