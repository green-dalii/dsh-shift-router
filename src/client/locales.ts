...
export const en: ShiftRouterCardDict = {
  ...
  'h.windowMinConfidence': 'A verdict below this is a HOLD: the router keeps its current tier, and the entry both fails to count toward a downgrade and resets any downgrade streak already built up.',
...
export const zh: ShiftRouterCardDict = {
  ...
  'h.windowMinConfidence': '低于该置信度的判定按 hold 处理：保持当前层；它既不计入降级连击，也会把已积累的连击清零。',
